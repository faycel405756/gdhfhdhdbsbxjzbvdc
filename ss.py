                ...
                while True:  
                    try:  
                        ...
                        if self.DaTa.hex().startswith("1200") and b"SecretCode" in self.DaTa:
                            ...
                            self.writer.write(RedZed_SendMsg(f"""[b][c][{ArA_CoLor()}]ＦＡＹＣＥＬ
...
[b][c][{ArA_CoLor()}]telegram: @V_C_D_1[/b]

[b][c][{ArA_CoLor()}]Instagram : @bxl2_8[b][c][{ArA_CoLor()}]
 
Enjoy the bot my friend.......

[b][c][{ArA_CoLor()}] Developer ＦＡＹＣＥＬ """ , TarGeT, bot_uid ,key , iv)) ; await self.writer.drain()
