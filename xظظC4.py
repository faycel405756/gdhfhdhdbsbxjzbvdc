...
def RedZed_3alamyia_Chat(uid, code , K, I):
 ...
 2: {
    ...
    return GeneRaTePk(str(redzed_fields) ,'0515', K, I)


def quit_caht_redzed(K,I):
...
def RedZed_SendInv(bot_uid, uid,K,V):
    fields = {1: 33, 2: {1: 2621529528, 2: "ME", 3: 1, 4: 1, 6: "RedZedKing!!", 7: 330, 8: 1000, 9: 100, 10: "DZ", 12: 1, 13: 2621529528, 16: 1, 17: {2: 159, 4: "y[WW", 6: 11, 8: "1.118.1", 9: 3, 10: 1}, 18: 306, 19: 18, 24: 902000306, 26: {}, 27: {1: 11, 2: int(bot_uid), 3: 999}, 28: {}, 31: {1: 1, 2: bAdge()}, 32: bAdge(), 34: {1: bot_uid, 2: 8, 3: "\u0010\u0015\b\n\u000b\u0013\f\u000f\u0011\u0004\u0007\u0002\u0003\r\u000e\u0012\u0001\u0005\u0006"}}}
    return GeneRaTePk(str(CrEaTe_ProTo(fields).hex()) , '0515' , K , V)
