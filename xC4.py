...
# استدعاء الدالة مرتين متتاليتين
first_badge = bAdge()
second_badge = bAdge()
...
def Send_GhosTs(Uid , sQ , K , V):
    fields =  {1: 61 , 2: {1: int(Uid) , 2: {1: int(Uid) , 2: 1159, 3: f'[ff0030][b][i][c]ＩＮＳＴＡ: {generate_random_color()}@ｂｘｌ２_８', 5: 12, 6: 999999999, 7: 3, 8: {2: 1, 3: 1}, 9: 6}, 3: sQ}}
    return GeneRaTePk(str(CrEaTe_ProTo(fields).hex()) , '0515' , K , V)
    ...
    2: {
        ...
        9: {
            1: "VaizSố2Gayy",
                ...
                8: "ᴅᴇᴠᴇʟᴏᴘᴇʀ",
                10: 2,
                11: 2010, #Số 2 Tương Ứng Với Danh Hiệu Top 2 Khu Vực Sinh Tồn
                12: 100,
                13: {
                    1: 2,
                    2: 1,
            ...
            14: {
                1: {
                    1: random.choice([1, 4]),
                    2: 1, #Số 1 Là Danh Hiệu Top Việt Nam - Các Số Từ 2 Trở Lên Là Các Tỉnh Thành Top Súng
                    3: random.randint(1, 180), #Random Danh Hiệu Súng
                    4: 1, #Số 1 Tương Ứng Với Top 1 Của Top Súng
...
def AuTo_ResTartinG():
    time.sleep(24 * 60 * 60) # زدت المدة ليوم كامل بدل 6 ساعات
