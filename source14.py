# File generated from source13.py
# generated_name: source14.py
# generated_at: 2026-02-18T11:07:42.495295Z
            ...
            try: 
                ...
                while True:  
                    try:  
                        ...
                        if not self.DaTa: await asyncio.sleep(0.001) ; break
                        if self.DaTa.hex().startswith('0500') and len(self.DaTa.hex()) > 100:                            
                            ...
                            if SuQ == None:
                                ...
                                self.writer2.write(Send_GhosTs(Uuu, "[ff0030][b][i][c]ＩＮＳＴＡ: [90EE90][b][i][c]@ｂｘｌ２_８", SuQ, key, iv));await self.writer2.drain()
                ...
                while True:  
                    try:  
                        ...
                        if self.DaTa.hex().startswith("1200") and b"SecretCode" in self.DaTa:
                            ...
                            self.writer.write(RedZed_SendInv(bot_uid,TarGeT,key,iv)); await self.writer.drain()
...
def load_accounts(file_path="vv14.json"):
